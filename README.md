...
The Sun Right Now is a desktop screensaver that displays 4K images of the sun in a mesmerizing slideshow. The photos are in real-time (minus 8 minutes due to the Earth's distance from the sun) and fetched from the [NASA SDO](https://sdo.gsfc.nasa.gov/), a satellite observatory currently orbiting Earth. The images are updated automatically every 5 minutes to ensure only the very latest captures are shown. Built with Nodejs, React and Electron. 
